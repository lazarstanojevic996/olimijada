...
@Component({
  selector: 'app-igra-user',
  templateUrl: './igra-user.component.html',
  styleUrls: ['./igra-user.component.css']
})
export class IgraUserComponent implements OnInit 
{
  text: any;
  igra: Igra;
  server: string;
...
*/
  ...
  ZatvoriTab()
  {
    ...
    this.yesNoDialogRef.afterClosed().subscribe(res =>
    {
      if (res == true)
      {
        this.turnirService.prijavljivanjeNaTurnir = false;
